...
def second_pass( commands, num_frames ):
    knob = [{} for x in range(num_frames)]
    ...
    for frame in range(num_frames):
        ...
        for command in commands:
            ...
            if c == 'set':
                ...
                if args[3] != None:
                    mx = args[0]*knob[frame][args[3]];
                    my = args[1]*knob[frame][args[3]];
                    mz = args[2]*knob[frame][args[3]];
                    args = [mx, my, mz]
                ...
                if args[3] != None:
                    sx = args[0]*knob[frame][args[3]];
                    sy = args[1]*knob[frame][args[3]];
                    sz = args[2]*knob[frame][args[3]];
                    args = [sx, sy, sz]
